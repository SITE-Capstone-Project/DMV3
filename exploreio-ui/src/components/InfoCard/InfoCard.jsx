...
export default function InfoCard({ isLoggedIn }) {
  ...
  const canFavoriteDest = async (destination) => {
    try {
      ...
      /* If they already have that favorited destination in their favorites,
      set the "ability to favorite" to false. */
  ...
  return (
    <div>
      {!destination ? (
        <h2 className = "not-logged"> Destination doesn't exist </h2>
      ) : (
        <div>
                  ...
                  <div>
                    ...
                    {isLoggedIn ? (
                      favorite ? (
                        ...
                        <button
                          className="favorite-button"
                          onClick={deleteFavoriteDestination}
                        >
                          <img
                            id="favorite-image"
                            src="https://png.pngtree.com/png-vector/20220428/ourmid/pngtree-smooth-glossy-heart-vector-file-ai-and-png-png-image_4557871.png"
              ...
              <div className="flights-section">
                <div>
                  <div className="flights">
                    <FlightForm
                      area={destination?.destinationInfo?.name}
