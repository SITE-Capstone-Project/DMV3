...
export default function Hotels({ hotels, destinationid, favorite, isLoggedIn, loadedFavorites }) {
    return (
...
export function HotelCard({ hotel, destinationid, favorite, isLoggedIn, loadedFavorites }) {
            ...
            {isLoggedIn ? (
                <div>
                    {favorite ? (
                        ...
                        canAddHotel ? (
                            <button id = "add-hotel" onClick={addHotelToFavorite}> Add Hotel </button>
                        ) : (
                            <button id = "remove-hotel" onClick={removeHotelFromFavorite}> Remove Hotel </button>
                        )
                    )}
                </div>
            ) : (<div></div>)}
